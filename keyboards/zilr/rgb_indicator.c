...
void rgb_indicator_on(void) {
    is31fl3199_rgb_pwm(RGB1, 255);
    is31fl3199_rgb_mode_config(RGB1, RGB1_MODE_ONESHOT);
    is31fl3199_rgb_timing(RGB1, T0_520MS, T1_T3_2080MS, T2_2080MS, T4_520MS, T1_T3_DT_TRUE);
    is31fl3199_rgb_ramping(RGB1, RGB1_RAMPING_ENABLE);
    is31fl3199_rgb_ramping_hold(RGB1, RGB1_HOLD_T2);
}
