...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [_FN] = LAYOUT_all(
        ...
        _______, FAD_TOG, FAD_REV, _______, _______, GX_TOGG, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, NK_TOGG, _______, _______, _______, _______, _______, KC_PGUP,
        CL_TOGG, GU_TOGG, AG_TOGG,                            _______,                            _______, _______, _______, KC_PGDN, _______
        ),
    [2] = LAYOUT_all(
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        ...
        case KC_A:
            if (record->event.pressed) {
                if (get_gelix_enable_state()) {
                    switch (get_gelix_mode()) {
                        case COUNTER_STRAFE:
                            break;
                        case MUTEX:
                            del_key(KC_D);
