...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT(
    KC_TRNS,RGB_MATRIX_TOG,RGBLIGHT_TOG,KC_TRNS,KC_TRNS,RGB_MATRIX_MOD,RGB_MATRIX_HUE,RGB_MATRIX_SAT,RGB_MATRIX_VAL,RGBLIGHT_MOD,RGBLIGHT_HUE,RGBLIGHT_SAT,RGBLIGHT_VAL,KC_TRNS,KC_TRNS,KC_TRNS,  
