...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT_all(
        QK_BOOT,   KC_F1,                        KC_F2,               KC_F3,                 KC_F4,              KC_F5,              KC_F6,              KC_F7,    KC_F8,        KC_F9,    KC_F10,   KC_F11,   KC_F12,   _______,  EE_CLR, 
        DB_TOGG,   RGB_INDICATOR_ENABLE_TOGGLE,  RGB_INDICATOR_MODE,  RGB_INDICATOR_SELECT,  RGB_INDICATOR_HUI,  RGB_INDICATOR_SAI,  RGB_INDICATOR_VAI,  _______,  DEVICE_INFO,  _______,  _______,  _______,  _______,  _______, 
        _______,   FADER_ENABLE_TOGGLE,          FADER_REVERSE,       FADER_CHI,             FADER_CCI,          _______,            _______,            _______,  _______,      _______,  _______,  _______,  _______,  _______, 
