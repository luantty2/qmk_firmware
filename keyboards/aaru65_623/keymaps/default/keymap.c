...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT(
        ...
        _______,   RGB_INDICATOR_HUI,  RGB_INDICATOR_SAI,  RGB_INDICATOR_VAI,  RGB_INDICATOR_MODE,  RGB_INDICATOR_SELECT,  RGB_INDICATOR_SHUTDOWN,  _______,  DEVICE_INFO,  _______,  _______,  _______,  _______,  _______, 
        _______,   _______,            _______,            _______,            _______,             _______,               _______,                 _______,  _______,      _______,  _______,  _______,  _______,  _______, 
        _______,   _______,            _______,            _______,            _______,             _______,               _______,                 _______,  _______,      _______,  _______,  _______,  _______,  _______, 
        _______,   GUI_TOG,            AG_TOGG,            _______,            _______,             _______,               _______,                 _______,  _______ 
        )
};
